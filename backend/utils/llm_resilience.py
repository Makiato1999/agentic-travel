...
async def retry_with_backoff(
    ...
    # Supplier<CompletableFuture<Result>> factory = () -> service.callAsync();
    ...
    for attempt in range(max_retries + 1):
        try:
            ...
            # await 如果一直卡住，必须靠底层 timeout 或外层 timeout
            # 底层 HTTP/LLM 调用如果超时，通常会抛：- TimeoutError - asyncio.TimeoutError - 或其他超时异常
