...
TEST_CASES = [
    ...
    # {
    #   "name": "ask info",
    #   "query": "厦门机场到市区一般怎么走？康莱德酒店在哪里，我从市区开完会的话要搭乘公共交通过去？",
    # },
    # {
    #     "name": "plan trip",
    ...
    {
        "name": "差旅综合场景",
        "query": "我现在搬家去了苏州，这次出差不想坐高铁了，改成优先直飞航班；酒店还是希望安静一些，最好靠近地铁站，饮食上改成清淡一点。下周我要从苏州去武汉出差4天，请先告诉我差旅费用一般要在多久内报销，再查一下武汉下周天气，并补充武汉有哪些适合商务入住的区域，最后结合这些最新偏好帮我规划一个商务出行方案。",
    },
]
